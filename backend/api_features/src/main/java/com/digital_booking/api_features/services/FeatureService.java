...
public class FeatureService {
    ...
    public FeatureDTO saveFeature(FeatureDTO f){
        ...
        return feature.mapToFeatureDTO(f.getIcon());
    }
    ...
    public void managmentImage(FeatureDTO feature){
        Image image = null;
        if(feature.getIcon().getId() == null) {
            image = imageService.saveImage(feature.getIcon());
        }else{
            try{
