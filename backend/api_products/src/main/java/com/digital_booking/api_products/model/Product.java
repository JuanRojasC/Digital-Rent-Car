...
public class Product {
    ...
    @ManyToMany
    private Collection<TermAndCondition> termsAndConditions = new ArrayList<>();
    ...
    public ProductDTO mapProductDTO(Category category, City city, Specs specs, Collection<Image> images, Collection<BookingDTO> bookings, Collection<TermAndConditionDTO> termsAndConditions){
        ...
        productDTO.setTermsAndConditions(termsAndConditions);
        return productDTO;
    }
}
